...
Alternatively, you can generate the Jupyter notebooks of the examples using [Literate.jl](https://github.com/fredrikekre/Literate.jl) by running the following command in the Julia REPL:
